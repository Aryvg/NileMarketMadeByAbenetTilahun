...
document.querySelector('.js-sign-up-button').addEventListener('click', ()=>{
  ...
  const MoreButtons=document.querySelector('.js-sign-up-buttons');
document.querySelector('.js-sign-up-buttons').addEventListener('click', ()=>{
    if (MoreButtons.innerText==='More'){
      document.querySelector('.sl-div').style.visibility='visible';
      MoreButtons.innerText='Cancel'
    }else{
      document.querySelector('.sl-div').style.visibility='hidden';
      MoreButtons.innerText='More';
    }
