...
document.querySelector('.js-sign-up-button').addEventListener('click', ()=>{
  ...
  const MoreButtond=document.querySelector('.js-sign-up-buttond');
document.querySelector('.js-sign-up-buttond').addEventListener('click', ()=>{
    if (MoreButtond.innerText==='More'){
      document.querySelector('.sl-div').style.visibility='visible';
      MoreButtond.innerText='Cancel'
    }else{
      document.querySelector('.sl-div').style.visibility='hidden';
      MoreButtond.innerText='More';
    }
